...
public class EditProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                updateProfile();
                Toast tt =Toast.makeText(getApplicationContext(),"Saved",Toast.LENGTH_SHORT);
    ...
    private void uploadImage() {
        ...
        if(mImageUri!=null){
            ...
            uploadTask.continueWithTask(new Continuation() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if(task.isSuccessful()){
                        ...
                        Toast tt=Toast.makeText(getApplicationContext(),"Uploading Failed",Toast.LENGTH_SHORT);
                        tt.setGravity(Gravity.CENTER,0,0);
                        tt.show();
                        pd.dismiss();
                    }
            ...
            Toast tt=Toast.makeText(getApplicationContext(),"No Image Selected",Toast.LENGTH_SHORT);
            tt.setGravity(Gravity.CENTER,0,0);
            tt.show();
        }
    }
